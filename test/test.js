...
describe('/minions routes', function() {
  let fakeDb = require('../server/db.js');

  describe('GET /minions', function() {
  ...
  describe('PUT /minions/:minionId', function() {
    ...
    it('called with an invalid ID does not change the database array', function() {
      ...
      return request(app)
        ...
        .then(() => {
          return request(app).get('/minions');
        })
  ...
  describe('POST /minions', function() {
  ...
  describe('DELETE /minions', function() {
...
describe('/ideas routes', function() {
  ...
  describe('PUT /ideas/:ideaId', function() {
...
describe('checkMillionDollarIdea middleware', function() {
  ...
  it('is used in a POST /ideas route to reject insufficiently profitable ideas', function() {
    return request(app)
      .post('/ideas')
      .send({
        name: 'Test',
...
describe('/meetings routes', function() {
  ...
  describe('DELETE /meetings route', function() {
...
xdescribe('BONUS: /minions/:minionId/work routes', function() {

  let fakeDb = require('../server/db.js').db;
  
    describe('GET /minions/:minionId/work', function() {
      ...
      it('called with a non-numeric minion ID returns a 404 error', function() {
        return request(app)
          .get('/minions/notAnId/work')
          .expect(404);
      });
  
      it('called with an invalid ID minion returns a 404 error', function() {
        return request(app)
          .get('/minions/450/work')
          .expect(404);
      });

    });
  
    describe('PUT /minions/:minionId/work/:workId', function() {
      ...
      it('updates the correct work and returns it', function() {
        ...
        return request(app)
          ...
          .then(() => {
            ...
            return request(app)
              .put(`/minions/2/work/${initialWork.id}`)
      ...
      it('called with an invalid ID does not change the database array', function() {
        ...
        return request(app)
          ...
          .then(() => {
            return request(app)
              .put('/minions/2/work/notAnId')
              .send({key: 'value'});
          })
          .then(() => {
            return request(app).get('/minions/2/work');
          })
          .then((response) => response.body)
    ...
    describe('POST /minions/:minionId/work', function() {
    ...
    describe('DELETE /minions/:minionId/work/:workId', function() {
      ...
      it('called with a non-numeric work ID returns a 404 error', function() {
        return request(app)
          .delete('/minions/notAnId/work/notAnId')
          .expect(404);
      });
  
      it('called with an invalid work ID returns a 404 error', function() {
        return request(app)
          .delete('/minions/450/work/450')
          .expect(404);
      });
